...
class Bestellung(models.Model):
    ...
    erledigt = models.BooleanField(("Erledig"), default=False)
...
class Adresse(models.Model):
    kunde = models.ForeignKey(Kunde, verbose_name=("Name"), on_delete=models.CASCADE)
    bestellung = models.ForeignKey(Bestellung, verbose_name=("Bestellung"), on_delete=models.CASCADE)
    adresse = models.CharField(("Adresse"), max_length=200, null=True, blank=True)
    plz = models.CharField(("Postleitzahl"), max_length=10, null=True, blank=True)
    stadt = models.CharField(("Stadt"), max_length=200, null=True, blank=True)
    land = models.CharField(("Bundesland"), max_length=50, null=True, blank=True)
    datum = models.DateTimeField(("Datum"), auto_now=False, auto_now_add=True)
    class Meta:
